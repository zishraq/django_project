...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('advising_portal', '0008_delete_coursestaken'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_id', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='advising_portal.student')),
            ],
        ),
    ]
