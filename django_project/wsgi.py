...
#     from advising_portal.models import RoutineSlot, TimeSlot, RoutineAndTime, Department, Course, Faculty, Section, Student, Semester, Grade, CoursesTaken
...
#     # ]
#     #
#     # for grade_report in grade_reports:
